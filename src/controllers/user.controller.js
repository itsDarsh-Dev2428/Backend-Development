...
const registerUser = asyncHandler(async (req, res) => {
    ...
    console.log("req.files:", req.files);     // should show uploaded files
...
const UpdateAccountFDetails = asyncHandler(async(req, res)=>{
    ...
    return res
    .status(200)
    .json(new ApiResponse, "user details updated successfully")
...
const updateUserAvatar = asyncHandler(async(req, res)=>{
    ...
    return res
    .status(200)
    .json(new ApiResponse(200, avatarupdate, "avatar updated succcessfully"))
...
const updateUserCoverImage = asyncHandler(async(req, res)=>{
    ...
    return res
    .status(200)
    .json(new ApiResponse(200, coverImageupdate, "CoverImage updated succcessfully"))
